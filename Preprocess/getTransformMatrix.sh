...
flirt -in ${dataFolder}/${experiment}/data/${sub}/masks/brain_m_BOLD.nii.gz -ref ${dataFolder}/${experiment}/data/${sub}/masks/brain_n_meanfct.nii.gz -out ${dataFolder}/${experiment}/data/${sub}/masks/a_brain_m_BOLD.nii.gz -omat ${dataFolder}/${experiment}/data/${sub}/masks/A02n_meanfct.mat -bins 256 -cost corratio -searchrx -90 90 -searchry -90 90 -searchrz -90 90 -dof 12  -interp trilinear
...
flirt -in ${dataFolder}/${experiment}/data/${sub}/masks/brain_m_BOLD.nii.gz -ref ${atlasFile} -applyxfm -init ${dataFolder}/${experiment}/data/${sub}/masks/A02std.mat -out ${dataFolder}/${experiment}/data/${sub}/masks/A0std.nii.gz
