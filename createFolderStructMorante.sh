...
inputFolder=/media/sf_data/MorantePreprocessed
dataFolder=/media/sf_data/MoranteProcessedB

declare -a subjects=("Morante") #for Bran I used run3 for A0
...
#	fileList=($(ls ${inputFolder}/${subjFolder})) #makes a list of the files in the folder
	...
	echo getting A0
	fslroi ${inputFolder}/${subjFolder}_run1.nii.gz ${dataFolder}/data/sub${subjS}/masks/A0.nii.gz 0 1 #gets the first volume of the first scan
	echo ${subjFolder}
...
#		echo outFolder = ${outFolder}/uncorrected.nii.gz
		...
		mcflirt -in ${outFolder}/uncorrected.nii.gz -r ${dataFolder}/data/sub${subjS}/masks/m_BOLD.nii.gz -out ${outFolder}/BOLD.nii.gz -report
